...
Mobile.tap(findTestObject('ACC Bid/detail_unit/btnlihatsemua'), 0)

Mobile.tap(findTestObject('ACC Bid/detail_unit/detail_unit_gambar1'), 0)

CustomKeywords.'ScrollUpDown.UpDown'(0, 0, 10, 10)

Mobile.tap(findTestObject('ACC Bid/detail_unit/deskripsi_unit'), 0)
