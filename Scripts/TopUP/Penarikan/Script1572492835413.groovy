...
if (JenisPenarikan == 'Astria') {
    ...
    if (Mobile.verifyElementVisible(findTestObject('TopUP/Penarikan/PopUpKelipatan'), 3, FailureHandling.OPTIONAL)) {
        ...
        if (Mobile.verifyElementVisible(findTestObject('TopUP/Penarikan/PopUPPenarikanMelibihiSaldo'), 3, FailureHandling.OPTIONAL)) {
            Mobile.verifyElementVisible(findTestObject('TopUP/BtnLanjut'), 3, FailureHandling.STOP_ON_FAILURE)
        } else {
            ...
            if (Mobile.verifyElementVisible(findTestObject('TopUP/Penarikan/KodeVerifikasiSalah'), 3, FailureHandling.OPTIONAL)) {
                Mobile.verifyElementVisible(findTestObject('TopUP/Penarikan/BTN_Verifikasi'), 3, FailureHandling.STOP_ON_FAILURE)
            } else {
    ...
    if (Mobile.verifyElementVisible(findTestObject('TopUP/PenarikanIBID/AlertPenarikanIBID'), 0, FailureHandling.OPTIONAL)) {
        Mobile.verifyElementVisible(findTestObject('TopUP/PenarikanIBID/BTNLANJUTIBID'), 0, FailureHandling.STOP_ON_FAILURE)
    } else {
    ...
    switch ('Result') {
        ...
        case 'Fail':
            ...
            if (Detail.toString() == 'No Saldo dan Harus Kelipatan 1') {
                Mobile.verifyElementVisible(findTestObject('TopUP/Penarikan/BTN_Lanjut'), 0)
